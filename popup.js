...
document.addEventListener("DOMContentLoaded", async () => {
  ...
  function applyActivationState(activated) {
    ...
    monkeyEyeToggle.disabled = disabled;
    autoSendImageToggle.disabled = disabled;
    aiReplyToggle.disabled = disabled;
  ...
  function syncToggles(settings) {
    ...
    monkeyEyeToggle.checked = settings.monkeyEyeEnabled === true;
    autoSendImageToggle.checked = settings.autoSendImageConfirm === true;
    aiReplyToggle.checked = settings.aiReplySuggestEnabled === true;
  }
